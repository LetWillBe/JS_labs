...
const answer = prompt("Вам есть 18?", "18");//prompt - модальное окно с полем ввода варианта ответа
...
//Команды alert confirm prompt работают только в браузере, в косоли они не определяются